...
// 数据初始置换表，将数据进行重新排列
static const unsigned char initial_permutation_table[TEXT_LEN] = {
...
static const unsigned char final_permutation_table[TEXT_LEN] = {
...
static const unsigned char extend_table[SUB_SECRET_KEY_LEN] = {
